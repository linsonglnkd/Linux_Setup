...
syn keyword pigFunctionName flatten sum count min max avg arity tokenize diff size concat epochToFormat contained
syn keyword pigFunctionName BinStorage PigStorage TextLoader PigDump LiAvroStorage IsEmpty contained
